...
CMD( Copyover )
{
    ...
    {
        NULL,
        "Kef the Storm arrives, causing the Winds of Change to flow through Ashyria.",
        "The Three will it so that the Realms must evolve.",
        "Kef the Storm arrives and the Winds of Change flow through Ashyria."
    };
...
CMD( Shutdown )
{
    ...
    while ( ( client = ( CLIENT * ) NextInList( &Iter ) ) )
    {
        ...
        SendBuffer( client, "Ashyria is shutting down.\r\n" );
    }
