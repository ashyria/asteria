...
CMD( News )
{
    if ( arg[0] == 0 || !HasTrust( unit, TRUST_STAFF ) )
    {
        ...
        if ( HAS_BIT( unit->client->mth->comm_flags, COMM_FLAG_MXP ) )
        {
            SendRawBuffer( unit->client, "\r\nEmail: \033[1z<A \"mailto://admin@ashyriamud.com\">admin@ashyriamud.com</A>\033[7z\r\n" );
            SendRawBuffer( unit->client, "Website/Wiki: \033[1z<A \"http://www.ashyriamud.com\">http://www.ashyriamud.com</A>\033[7z\r\n" );
            SendRawBuffer( unit->client, "Forums: \033[1z<A \"http://www.ashyriamud.com/forums\">http://www.ashyriamud.com/forums</A>\033[7z\r\n" );
            SendRawBuffer( unit->client, "Discord: \033[1z<A \"https://discord.gg/N4n8P5nhyB\">https://discord.gg/N4n8P5nhyB</A>\033[7z\r\n" );
        }
        else
        {
            SendRawBuffer( unit->client, "\r\nEmail: admin@ashyriamud.com\r\n" );
            SendRawBuffer( unit->client, "Website/Wiki: http://www.ashyriamud.com\r\n" );
            SendRawBuffer( unit->client, "Forums: http://www.ashyriamud.com/forums\r\n" );
