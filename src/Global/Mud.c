...
void UpdateWorld( void )
{
    ...
    switch ( hour )
    {
        ...
        case 6: strcpy( buf, "As the moon sets in the west, the rising sun emerges on the eastern\n\rhorizon, casting its light across the realm of Ashyria.\n\r" ); break;
        case 12: strcpy( buf, "The shining sun has reached its apex over the realm of Ashyria.\n\r" ); break;
        ...
        case 24: strcpy( buf, "The glowing moon has reached its apex over the realm of Ashyria.\n\r" ); break;
    }
